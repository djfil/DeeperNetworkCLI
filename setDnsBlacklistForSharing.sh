...
curl_command="curl -k 'https://$api_host/api/sharing/setDnsBlacklistForSharing' -X 'POST' -H 'Authorization: $bearer_token' --data-binary '{\"dnsBlacklistForSharing\":$mode}' -H 'Content-Type: application/json'"
