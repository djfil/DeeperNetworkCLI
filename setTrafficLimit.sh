...
curl_command="curl 'http://34.34.34.34/api/sharing/setTrafficLimit' -X 'POST' -H 'Authorization: $bearer_token' --data-binary '{\"number\":$mode,\"unit\":\"GB\"}' -H 'Content-Type: application/json'"
