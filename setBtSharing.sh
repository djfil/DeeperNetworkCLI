...
curl_command="curl -k 'https://34.34.34.34/api/sharing/setBtSharing' -X 'POST' -H 'Authorization: $bearer_token' --data-binary '{\"btEnabled\":$mode}' -H 'Content-Type: application/json'"
