...
curl_command="curl -k 'https://$api_host/api/sharing/setBtSharing' -X 'POST' -H 'Authorization: $bearer_token' --data-binary '{\"btEnabled\":$mode}' -H 'Content-Type: application/json'"
