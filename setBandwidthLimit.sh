...
curl_command="curl -k 'https://$api_host/api/sharing/setBandwidthLimit' -X 'POST' -H 'Authorization: $bearer_token' --data-binary '{\"number\":$result}' -H 'Content-Type: application/json'"
